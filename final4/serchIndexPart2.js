...
// * O(m*q*n) - читаем все слова во всех запросах и вообще еще проходимся по всем вхождениям в документы 'привет' -> { 1: 10, 2: 1 }, но эта часть (количество ключей { 1: 10, 2: 1 }) ожидается что значительно меньше (особенно если игнорировать предлоги всякие)
