...
function search(node, currMax = Number.NEGATIVE_INFINITY) {
    
}


// function search(node, currMax = node.value) {
//     // console.log(node.id);
...
//     if (node.left) {
//         currMax = search(node.left, currMax);
//     }
//     if (node.right) {
//         currMax = search(node.right, currMax);
//     }
