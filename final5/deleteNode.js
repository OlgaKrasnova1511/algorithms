...
// когда вернули СТАРЫЙ контест https://contest.yandex.ru/contest/24810/run-report/138987820/
...
// Память O(H) - стек обхода дерева максимум === высоте дерева
// Сложность алгоритма - на произвольном дереве поиска операции поиска, вставки и удаления в худшем случае будут работать за О(H), в сбалансированном дереве это O(logH)
// "а если несбалансированное, а произвольное? (связано с комментом выше)" - не поняла вопроса. выше формулировка взята из теории курса, для меня (насколько я поняла) есть сбалансированные деревья (где высота левого и правого поддерева отличается не более чем на 1) и несбалансированные/произвольные, они могут быть вплоть по просто связного списка по структуре
